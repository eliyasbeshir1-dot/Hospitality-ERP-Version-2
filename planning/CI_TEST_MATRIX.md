...
controls long after there were six jobs, twenty-four suites and 163 controls.
...
Twenty-four suites: eighteen that each verify one slice, and six that cut across gates.
...
A control that never fails is not a control. There are 163 of them — M1 22, M2 22, M3 35, M4 65, M5 10, M6 9. The database job
