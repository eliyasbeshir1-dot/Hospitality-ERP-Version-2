...
controls long after there were six jobs, twenty-seven suites and 172 controls.
...
Twenty-seven suites: twenty-one that each verify one slice, and six that cut across gates.
...
| `tests/m6a/verify_m6a.py` | one slice |
| `tests/m6b/verify_m6b.py` | one slice |
| `tests/m6c/verify_m6c.py` | one slice |
| `tests/m6d/verify_m6d.py` | one slice |
| `tests/m6e/verify_m6e.py` | one slice |
| `tests/opa/verify_opa.py` | cross-cutting |
| `tests/opb/verify_opb.py` | cross-cutting |
| `tests/opc/verify_opc.py` | cross-cutting |
| `tests/opd/verify_opd.py` | cross-cutting |
...
A control that never fails is not a control. There are 172 of them — M1 22, M2 22, M3 35, M4 65, M5 10, M6 18. The database job
