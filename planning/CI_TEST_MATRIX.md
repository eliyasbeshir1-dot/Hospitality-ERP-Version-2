...
controls long after there were six jobs, twenty-three suites and 158 controls.
...
Twenty-three suites: seventeen that each verify one slice, and six that cut across gates.
...
A control that never fails is not a control. There are 158 of them — M1 22, M2 22, M3 35, M4 65, M5 10, M6 4. The database job
