...
controls long after there were six jobs, seventeen suites and 123 controls.
...
Seventeen suites: fourteen that each verify one slice, and three that cut across gates.
...
A control that never fails is not a control. There are 123 of them — M1 22, M2 22, M3 35, M4 44. The database job
