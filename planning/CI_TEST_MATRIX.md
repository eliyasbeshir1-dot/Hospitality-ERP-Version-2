...
controls long after there were six jobs, sixteen suites and 114 controls.
...
Sixteen suites: fourteen that each verify one slice, and two that cut across gates.
...
A control that never fails is not a control. There are 114 of them — M1 22, M2 22, M3 35, M4 35. The database job
