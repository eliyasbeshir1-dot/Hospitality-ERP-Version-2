...
48 of them, `0001_organizational_model_and_rls.sql` through `0048_an_update_is_checked_before_it_lands_and_leaves_the_queues_alone.sql`, across
...
- **`report`** — the metric catalog, the readings computed from it, the snapshots taken when a shift is signed off, and the exports
