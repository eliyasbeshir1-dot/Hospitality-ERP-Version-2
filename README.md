...
**Gate:** M6 — complete through **M6-D**, awaiting independent review as a whole
...
M0 → M0R → **M1 (A, B, C, D — complete)** → **M2 (A, B, C — complete)** → **M3 (A, B, C, D — complete)** → **M4 (A, B, C — complete)** → M5a → M5b → **M6 (A, B, C, D — landed, in review)**.
