...
**Gate:** M6 — complete through **M6-A**, awaiting independent review as a whole
...
| `tests/` | verification suites — 18 that each verify one slice, and 6 that cut across gates |
...
M0 → M0R → **M1 (A, B, C, D — complete)** → **M2 (A, B, C — complete)** → **M3 (A, B, C, D — complete)** → **M4 (A, B, C — complete)** → M5a → M5b → **M6 (A — landed, in review)**.
