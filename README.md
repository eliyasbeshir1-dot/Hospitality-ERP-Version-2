...
**Gate:** M4 — complete through **M4-C**, awaiting independent review as a whole
...
M0 → M0R → **M1 (A, B, C, D — complete)** → **M2 (A, B, C — complete)** → **M3 (A, B, C, D — complete)** → **M4 (A, B, C — landed, in review)** → M5a → M5b → M6.
