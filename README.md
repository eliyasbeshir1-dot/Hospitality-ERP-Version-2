...
**Gate:** M3 — complete through **M3-B**, awaiting independent review as a whole
...
M0 → M0R → **M1 (A, B, C, D — complete)** → **M2 (A, B, C — complete)** → **M3 (A, B — landed, in review)** → M4 → M5a → M5b → M6.
